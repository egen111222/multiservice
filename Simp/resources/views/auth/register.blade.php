...
@section('body')
                    ...
                    <form class="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Введите имя</label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" placeholder="Введите Пароль" type="password" class="form-control" name="password" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" placeholder="Введите Пароль"  type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
